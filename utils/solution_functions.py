...
def run_command_with_npx(
    ...
    try:
        subprocess.run(
            [npx_path, "-y", f"prettier@{prettier_version}", "--version"],
            check=True,
            capture_output=True,
            text=True
        )
        ...
        result = subprocess.run(
            ...
            shell=True,
            encoding="utf-8",
            errors="ignore"  # Ignores problematic characters instead of throwing errors
        )
...
def use_github(new_email: str = "23f3001208@ds.study.iitm.ac.in") -> str:
    """
...
def host_your_portfolio_on_github_pages(new_email: str = "23f3001208@ds.study.iitm.ac.in") -> str:
    """
    Updates the email in index.html and deploys to GitHub Pages.

    Args:
        new_email (str): New email to display (default: "23f3001208@ds.study.iitm.ac.in").
...
def create_a_github_action(new_email: str = "23f3001208@ds.study.iitm.ac.in") -> str:
    """
    Updates the email in the GitHub Actions workflow and triggers the workflow.

    Args:
        new_email (str): New email to display in the workflow (default: "23f3001208@ds.study.iitm.ac.in").
...
def create_a_scheduled_github_action(
    repo_owner="23f3001208",           
    repo_name="TDS-Graded-Assignment-4-8",               
    token=os.getenv("GITHUB_ACTION_TOKEN"),  # Set default to required token
    email="23f3001208@ds.study.iitm.ac.in",  # Set default to required email
    cron="30 23 * * *",                   
